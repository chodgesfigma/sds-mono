  ...
  render() {
    return (
      <SdsIcon size={this.size}>
        <g clip-path="url(#clip0_68_16011)">
          <path
          ...
          />
          <path d="M9.99992 5.99992H5.99992V9.99992H9.99992V5.99992Z" stroke="var(--svg-stroke-color)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
          <clip-path id="clip0_68_16011">
