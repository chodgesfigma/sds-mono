...
export class SdsLogo {
  ...
  @Prop() logoOptions?: AnchorOrButtonProps;

  render() {
    return (
      <AnchorOrButton {...this.logoOptions} class="logo">
        <svg width="172" height="247" viewBox="0 0 172 247" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M164 46.5C164 67.763 146.763 85 125.5 85L86 85L86 8.0001L125.5 8.0001C146.763 8.0001 164 25.2371 164 46.5V46.5Z"
            stroke="var(--logo-color)"
            stroke-width="15.081"
          />
          <path d="M8 46.5C8 67.763 25.237 85 46.5 85L86 85L86 8.0001L46.5 8.0001C25.237 8.0001 8 25.2371 8 46.5V46.5Z" stroke="var(--logo-color)" stroke-width="15.081" />
          <path
