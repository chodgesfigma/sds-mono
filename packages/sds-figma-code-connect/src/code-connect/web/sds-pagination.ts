...
figma.connect('<FIGMA_PAGINATION_PAGINATION_PAGE>', {
  ...
  example: ({ pageNumber, current }) => html`
    <sds-pagination-page current=${current} page-number=${pageNumber}>
      ${pageNumber}
    </sds-pagination-page>
  `,
});
...
figma.connect('<FIGMA_PAGINATION_PAGINATION_PREVIOUS>', {
  ...
  example: ({ href }) =>
    html`<sds-pagination-previous href=${href}></sds-pagination-previous>`,
});

figma.connect('<FIGMA_PAGINATION_PAGINATION_NEXT>', {
  props: PAGINATION_NEXT_PROPS,
  example: ({ href }) =>
    html`<sds-pagination-next href=${href}></sds-pagination-next>`,
});
