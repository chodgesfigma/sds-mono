...
figma.connect('<FIGMA_INPUTS_INPUT_FIELD>', {
  ...
  example: ({ isDisabled, value, placeholder }) => html`<sds-input disabled=${isDisabled} default-value=${value} placeholder=${placeholder}></sds-input>`,
});
...
figma.connect('<FIGMA_INPUTS_INPUT_FIELD>', {
  ...
  example: ({ isDisabled, value, placeholder, description, label, errorMessage }) =>
