  ...
  render() {
    return (
      <SdsIcon size={this.size}>
        <g clip-path="url(#clip0_68_16087)">
          <path d="M15.3332 4.66683L10.6665 8.00016L15.3332 11.3335V4.66683Z" stroke="var(--svg-stroke-color)" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" />
          <path
